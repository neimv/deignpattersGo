...
func (e EstrategiaResta) RealizarOperacion(num1, num2 int) int {
	return num1 - num2
}

// Estategia Multiplicacion
type EstrategiaMultiplica struct{}

func (e EstrategiaMultiplica) RealizarOperacion(num1, num2 int) int {
	return num1 * num2
}
...
func (c *Contexto) EjecutarOperacion(num1, num2 int) int {
